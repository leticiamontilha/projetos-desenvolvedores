...
import { validateKeysDataDev, emailExist, idExist } from "./middlewares/developers.middlewares"
...
app.post("/developers", validateKeysDataDev, emailExist, createDeveloper)
